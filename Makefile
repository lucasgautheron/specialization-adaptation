...
Fig*.pdf:
	...
	cp -L adaptation_specialization_material/output/etm_20_pretrained/sankey_control_control_nu_compact.pdf ./Fig3.pdf
	...
	cp -L adaptation_specialization_material/output/etm_20_pretrained/exited_score_effects_entropy_magnitude.eps ./Fig6.eps
