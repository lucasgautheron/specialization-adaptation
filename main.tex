...
A central dilemma of adaptation consists in choosing which  resources to leverage among those already available (which may be suboptimal under new circumtances) and which resources to throw out and replace with others (which may be inefficiently costly). 
