...
While the paper focuses on two time periods (2000-2009 and 2015-2019), multiple alternative temporal segmentations can be considered. Figure \ref{fig:sankey_five_years} shows the transfers of research attention of a cohort of physicists across four time-periods of five years each. It reveals that the changes outlined above have unfolded rather gradually. The average diversity of phyiscists' research portfolio ($\mu(D)$) during each five-year time-bin is also shown. It has gradually increased over the years ($P<10^{-4}$): on average, physicists have \textit{expanded} their portfolio.
