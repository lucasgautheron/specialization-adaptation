...
\begin{subfigure}[b]{0.22\textwidth}
    ...
    latent/.style={circle,draw,color=black,inner sep=1pt, minimum size=24pt}
        ...
        \node [obs](I) [left of=theta] {$\bm{I_a}$};
        \node [obs](S) [above of=I] {$\bm{S_a}$};
        \draw [->] (X) edge (Y);
        \draw [->] (theta) edge (Y);
