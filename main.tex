...
Then, leveraging the connection between our model and Optimal Transport, we showed that the reallocation of research efforts among scientists appears to be mainly structured by ``learning costs''. This supports our view that much of scientists' strategic behavior in response to change consists in balancing learning costs with the incentives for adaptation that they receive.
