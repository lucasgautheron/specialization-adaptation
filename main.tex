...
\fontsize{6}{7}\selectfont\input{tables/Table1}\normalsize
...
\begin{figure}[h]
    \centering     \includegraphics[width=0.8\textwidth]{plots/Fgi15.eps}
...
\fontsize{6}{7}\selectfont\input{tables/Table4}\normalsize
\fontsize{6}{7}\selectfont\input{tables/Table5}\normalsize
