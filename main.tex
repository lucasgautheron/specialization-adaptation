...
\begin{subfigure}{.45\textwidth}
    \includegraphics[width=1.15\textwidth]{Fig2a}
...
\begin{subfigure}{0.45\textwidth}
    \includegraphics[width=1.15\textwidth]{Fig2b}
...
\begin{figure}[!h]
    ...
    \caption{\textbf{Aggregate transfers of attention throughout the years 2000 to 2019, considering four time-intervals of five years each}. $\mu(D)$ is the average portfolio diversity of the cohort during each time-period.}
