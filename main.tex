...
Where $\nu_{k'|k}$ is the fraction of physicists with expertise in $k$ (i.e. with more intellectual capital than average in $k$) that also have expertise in $k'$. 
