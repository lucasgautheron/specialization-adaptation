...
\fontsize{6}{7}\selectfont\input{tables/summary_change_disruption}\normalsize
\renewcommand{\arraystretch}{1}

\renewcommand{\arraystretch}{2}
\fontsize{6}{7}\selectfont\input{tables/summary_entered_exited}\normalsize
\renewcommand{\arraystretch}{1}
