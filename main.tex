...
A central dilemma of adaptation consists in choosing which  resources should be leveraged among those already available (which may be suboptimal under new circumtances) and which resources should be thrown out and replaced with others (which may be inefficiently costly). 
...
\paragraph{Data, code and materials}{The data and code used for this publication is available at \url{https://github.com/lucasgautheron/specialization-adaptation/}. It will be archived on Zenodo upon publication.}
