...
Moreover, although the unsupervised topic model approach is arguably a better proxy to linguistic and cognitive behavior, it introduces noise which could in part explain the low predictive power of the models of change in scientists' research agendas.
