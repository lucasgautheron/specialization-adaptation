...
A central dilemma of adaptation consists in choosing between leveraging available resources (which may be suboptimal under new circumtances) and acquiring new resources (which may be inefficiently costly). 
