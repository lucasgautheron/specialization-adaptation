...
% \usepackage{natbib}
\usepackage[backend=biber, style=numeric-comp, sortcites=false,sorting=none,uniquelist=false,natbib=true,doi=true,isbn=false,url=false,eprint=false,pagetracker, ibidtracker=constrict, firstinits=true]{biblatex}
\DeclareSourcemap{
  \maps{
    \map{
