...
While the paper focuses on two time periods (2000-2009 and 2015-2019), multiple alternative temporal segmentations can be considered. Figure \ref{fig:sankey_five_years} shows the transfers of research attention of a cohort of physicists across four time-periods of five years each. 

\begin{figure}[!h]
    \centering
    \includegraphics[width=0.8\textwidth,trim={2.1cm 1.5cm 2.1cm 1.5cm},clip]{sankey_four.pdf}
    \caption{Aggregate transfers of attention throughout the years 2000 to 2019, consider four time-intervals of five years each. $\mu(D)$ is the average portfolio diversity of the cohort during each time-period.}
...
The word2vec skip-gram models is trained using different values for $L$ the dimension of the embeddings' space. $L=50$ (the choice made in the present paper) generally lies somewhere between under-fitting and over-fitting.
...
\begin{figure}[H]
    ...
    \caption{\textbf{Effect of intellectual capital, social capital, and institutional stability the magnitude of changes in high-energy physicists' interests} (alternative topic model, $K_0=15$).}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{entered_score_effects_entropy_magnitude_15.pdf}
    \caption{\textbf{Effect of intellectual capital, social capital, and institutional stability on the the probability of entering/leaving a research area} (alternative topic model, $K_0=15$).}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{change_score_effects_entropy_magnitude_25.pdf}
    \caption{\textbf{Effect of intellectual capital, social capital, and institutional stability the magnitude of changes in high-energy physicists' interests} (alternative topic model, $K=25_0$).}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{entered_score_effects_entropy_magnitude_25.pdf}
    \caption{\textbf{Effect of intellectual capital, social capital, and institutional stability on the the probability of entering/leaving a research area} (alternative topic model, $K=25_0$).}
\end{figure}
