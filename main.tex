...
Evaluting the effect of intellectual and social capital on scientists' trajectories requires quantitative measures of these concepts. An extensive review of prior usage of Bourdieu's notion of capital in bibliometrics has been provided by \citet[p.~198-200]{Schirone2023}, with most references addressing symbolic and social capital, and a few addressing cultural/intellectual/semantic capital. In the following, a consistent unsupervised approach for measuring intellectual and social capital using vector representations is proposed, from which measures of diversity and power are derived.
